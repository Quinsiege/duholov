...
const CORE = [
  ...
  './js/map.js', './js/encounter.js', './js/raid.js', './js/duel.js', './js/trade.js', './js/tutorial.js', './js/album.js', './js/league.js', './js/backup.js',
  './js/journal.js', './js/friends.js', './js/coop.js', './js/cloud.js', './js/updater.js', './js/ui.js', './js/main.js',
