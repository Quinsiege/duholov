...
const CORE = [
  ...
  './js/version.js?v=dev', './js/config.js?v=dev', './js/move.js?v=dev', './js/errors.js?v=dev', './js/settings.js?v=dev', './js/data.js?v=dev', './js/util.js?v=dev', './js/diff.js?v=dev', './js/art.js?v=dev', './js/skins-art.js?v=dev', './js/looks-art.js?v=dev', './js/art-kit.js?v=dev', './js/cutscene-art.js?v=dev', './js/sp-fire.js?v=dev', './js/sp-water.js?v=dev', './js/sp-forest.js?v=dev', './js/sp-forest2.js?v=dev', './js/sp-wind.js?v=dev', './js/sp-wind2.js?v=dev', './js/sp-current.js?v=dev', './js/sp-shadow.js?v=dev', './js/sp-shadow2.js?v=dev', './js/state.js?v=dev', './js/events.js?v=dev', './js/sky.js?v=dev', './js/music.js?v=dev', './js/world.js?v=dev',
  './js/navmap.js?v=dev', './js/map.js?v=dev', './js/encounter.js?v=dev', './js/raid.js?v=dev', './js/duel.js?v=dev', './js/rules.js?v=dev', './js/trade.js?v=dev', './js/tutorial.js?v=dev', './js/album.js?v=dev', './js/league.js?v=dev',
