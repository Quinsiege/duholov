...
const SPRING_ADJ = ['Тихий', 'Звонкий', 'Лунный', 'Студёный', 'Туманный', 'Серебряный', 'Старый', 'Забытый', 'Шепчущий', 'Ясный', 'Полночный', 'Медовый', 'Светлый', 'Глубокий', 'Росистый', 'Заветный'];
const SPRING_NOUN = ['родник', 'ключ', 'колодец', 'исток'];
